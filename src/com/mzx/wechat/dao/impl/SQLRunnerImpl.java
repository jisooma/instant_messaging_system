...
import com.mzx.wechat.dao.ResultMapper;
import com.mzx.wechat.dao.SQLMapper;
import com.mzx.wechat.dao.SQLRunner;
import com.mzx.wechat.exception.DaoException;
import com.mzx.wechat.util.JdbcUtils;
...
import static com.mzx.wechat.util.ReflectUtils.getFields;
import static com.mzx.wechat.util.ReflectUtils.getMethods;
import static com.mzx.wechat.util.StringUtils.field2SqlField;
...
public class SQLRunnerImpl implements SQLRunner {
    ...
    public LinkedList queryList(String sql, Object[] params, Class clazz) {
        return (LinkedList) executeQuery(sql, params, rs -> {
             ...
             * @see com.mzx.www.dao.inter.ResultMapper
             */
